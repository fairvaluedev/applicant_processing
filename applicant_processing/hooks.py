...
scheduler_events = {
	"hourly": [
		"applicant_processing.applicant_processing.utils.push_api.check_reminders"
	]
}
...
# before_tests = "applicant_processing.install.before_tests"

# Overriding Methods
# ------------------------------
#
# override_whitelisted_methods = {
# 	"frappe.desk.doctype.event.event.get_events": "applicant_processing.event.get_events"
# }
#
...
# 	"Task": "applicant_processing.task.get_dashboard_data"
# }
...
# Request Events
# ----------------
# before_request = ["applicant_processing.utils.before_request"]
# after_request = ["applicant_processing.utils.after_request"]

# Job Events
# ----------
# before_job = ["applicant_processing.utils.before_job"]
# after_job = ["applicant_processing.utils.after_job"]
...
# auth_hooks = [
# 	"applicant_processing.auth.validate"
# ]
